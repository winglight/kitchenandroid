...
public class SettingsActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        isHome = intent.getBooleanExtra(IS_HOME_EXTRA_DATA, true);
        
        SmartMealConditionParam params =  null;
        if(isHome){
         params = user.getObjSmartParams();
        }else{
        	params = user.getObjOutParams();	
        }

        addFragment(HealthConditionSettingsFragment.newInstance(params, isHome), TAG);
	...
	public void toastMsg(int resId) {
		...
		runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(SettingsActivity.this, msg, Toast.LENGTH_LONG)
						.show();
			}
		});
	}
