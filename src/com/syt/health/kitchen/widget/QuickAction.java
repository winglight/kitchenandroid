...
//			text.setSingleLine(true);
	...
	public void show (View anchor) {
		...
		int left = 0;
		if(anchorRect.centerX() > xPos){
			left = anchorRect.centerX() - xPos;
		}else{
			xPos = anchorRect.centerX() - 10;
		}
		
		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), left);
	...
	private void showArrow(int whichArrow, int requestedX) {
        ...
        ViewGroup parent = (ViewGroup) showArrow.getParent();
        
        parent.setPadding(requestedX, 0, 0, 0);
