...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(getResources().getDimension(R.dimen.text_size));
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(getResources().getDimension(R.dimen.text_size));
		...
		//setBackgroundResource(R.drawable.bg_setcondition);
	}
	...
	private int getMaxTextLength() {
		...
		return maxText != null ? maxText.length()*2 : 0;
	}
